    ...
    return(
        <nav className="flex-grow">
            <ul className="flex border-b">
              ...
              <li className={`mr-1 py-2 px-4 opacity-30 ${currentTab === 'Simulate' ? 'bg-gray-700' : 'text-white'}`}>
                Simulate {robotIcon}
              </li>
              
              <li className={`mr-1 py-2 px-4 opacity-30 ${currentTab === 'List' ? 'bg-gray-700' : 'text-white'}`} >
                Tool List {listIcon}
              </li>
            </ul>
        </nav>
